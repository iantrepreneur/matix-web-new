-- Configuration de la table user_profiles (version corrigée)
...
-- Note: Remplacer les IDs par les vrais IDs d'utilisateurs de votre base
-- Vous pouvez d'abord exécuter: SELECT id, user_type, business_name FROM users;

-- Exemple avec des IDs fictifs (à remplacer par les vrais IDs)
-- INSERT INTO user_profiles (user_id, name, email, phone, avatar, city, address, bio) VALUES
--   ('REMPLACER_PAR_VRAI_ID_1', 'Amadou Diallo', 'amadou@example.com', '+221 77 123 4567', 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=100', 'Dakar', 'Marché Colobane, Dakar', 'Producteur de volailles passionné'),
--   ('REMPLACER_PAR_VRAI_ID_2', 'Fatou Sall', 'fatou@example.com', '+221 76 234 5678', 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100', 'Thiès', 'Zone industrielle, Thiès', 'Distributeur spécialisé en produits avicoles')
