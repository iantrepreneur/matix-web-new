...
export default function CategoriesPage() {
  ...
  const categories = [
    { icon: "🐔", name: "Volailles Vivantes", id: "poultry" },
    { icon: "🥚", name: "Œufs & Reproduction", id: "eggs" },
    { icon: "🍽️", name: "Mangeoires & Abreuvoirs", id: "feeders" },
    { icon: "🏠", name: "Équipements Élevage", id: "equipment" },
    { icon: "🌾", name: "Aliments & Nutrition", id: "feed" },
    { icon: "💉", name: "Soins Vétérinaires", id: "veterinary" },
    { icon: "🧽", name: "Hygiène & Nettoyage", id: "hygiene" },
    { icon: "📦", name: "Conditionnement", id: "packaging" }
  ];
      ...
      <div className="bg-white border-b border-gray-200 py-3">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-8">
            ...
            <Link href="/categories" className="text-matix-green-medium font-medium">Catégories</Link>
                ...
                {categories.map((category, index) => (
                  <div 
                    ...
                    className={`flex flex-col items-center cursor-pointer transition-all ${
                      selectedCategory === index ? 'text-matix-green-medium' : 'text-gray-600 hover:text-matix-green-medium'
                    }`}
                    onClick={() => setSelectedCategory(index)}
                  >
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl mb-2 ${
                      selectedCategory === index ? 'bg-matix-green-pale' : 'bg-gray-100'
                    }`}>
                      {category.icon}
                    </div>
