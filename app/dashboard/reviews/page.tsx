...
export default function MyReviewsPage() {
  ...
  const reviewedProducts = [
    ...
    {
      name: "Couveuse 100 Œufs",
      image: "https://images.pexels.com/photos/1267697/pexels-photo-1267697.jpeg?auto=compress&cs=tinysrgb&w=200",
      rating: 5
    }
  ];

  const needToReviewProducts = [
    {
      name: "Poulet Chair Ross",
      image: "https://images.pexels.com/photos/1556909/pexels-photo-1556909.jpeg?auto=compress&cs=tinysrgb&w=200"
    },
    {
  ...
  const openReviewModal = (productName: string) => {
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
              ...
              {activeTab === 'reviewed' 
                ? reviewedProducts.map((product, index) => (
                    <Card key={index} className="p-4 text-center">
                      ...
                      <Button 
                        className="w-full bg-matix-green-medium hover:bg-matix-green-dark text-white text-sm"
                        onClick={() => openReviewModal(product.name)}
                      >
                        Edit Review
                      </Button>
                    </Card>
                  ))
                : needToReviewProducts.map((product, index) => (
                    <Card key={index} className="p-4 text-center">
                      <div className="aspect-square mb-4 overflow-hidden rounded-lg">
                        <img 
                          src={product.image} 
                      ...
                      <h3 className="font-medium text-sm mb-4 line-clamp-2">{product.name}</h3>
                      <Button 
                        className="w-full bg-matix-green-medium hover:bg-matix-green-dark text-white text-sm"
                        onClick={() => openReviewModal(product.name)}
                      >
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600 mb-4">SHOWING 1-16 OF 148</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">Review for {selectedProduct}</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="mb-4">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                ...
                <p className="text-gray-600 mb-1">Drag your image here</p>
            ...
            <Button 
              className="w-full bg-matix-green-medium hover:bg-matix-green-dark text-white"
              onClick={() => setIsModalOpen(false)}
            >
              Submit Review
            </Button>
