...
export default function ClientReviewsPage() {
  ...
  const productsToReview = [
    ...
    },
    {
      ...
      vendor: "EquipPro Solutions",
      purchaseDate: "24/08/25",
      image: "https://images.pexels.com/photos/1300357/pexels-photo-1300357.jpeg?auto=compress&cs=tinysrgb&w=200",
      price: "15,500 FCFA"
    },
    {
      id: 4,
      name: "Vaccins Newcastle",
      vendor: "VetSen Laboratoire",
      purchaseDate: "22/08/25",
      image: "https://images.pexels.com/photos/3786215/pexels-photo-3786215.jpeg?auto=compress&cs=tinysrgb&w=200",
      price: "12,500 FCFA"
    }
  ];
  ...
  const givenReviews = [
    {
      id: 1,
      vendor: "Ferme Diallo",
      product: "Poulets fermiers bio",
      rating: 5,
      comment: "Excellents poulets, très frais et de qualité supérieure. Livraison rapide et vendeur très professionnel.",
      date: "25/08/25",
      image: "https://images.pexels.com/photos/1556909/pexels-photo-1556909.jpeg?auto=compress&cs=tinysrgb&w=120",
      criteria: { quality: 5, delivery: 5, service: 5, value: 4 }
    },
    {
      id: 2,
      vendor: "Élevage Bio",
      product: "Œufs bio extra frais",
      rating: 4,
      comment: "Œufs de très bonne qualité, livraison rapide. Prix un peu élevé mais justifié par la qualité.",
      date: "22/08/25",
      image: "https://images.pexels.com/photos/162712/egg-white-food-protein-162712.jpeg?auto=compress&cs=tinysrgb&w=120",
      criteria: { quality: 4, delivery: 5, service: 4, value: 3 }
    },
    {
      id: 3,
      vendor: "Distribution Pro",
      product: "Aliment ponte standard",
      rating: 3,
      comment: "Bon produit mais délai de livraison dépassé. Service client à améliorer.",
      date: "18/08/25",
      image: "https://images.pexels.com/photos/533360/pexels-photo-533360.jpeg?auto=compress&cs=tinysrgb&w=120",
      criteria: { quality: 4, delivery: 2, service: 3, value: 4 }
    },
    {
      id: 4,
      vendor: "MatEquip Plus",
      product: "Abreuvoir automatique",
      rating: 5,
      comment: "Matériel de très bonne qualité, installation facile. Vendeur très réactif et professionnel.",
      date: "15/08/25",
      image: "https://images.pexels.com/photos/1300357/pexels-photo-1300357.jpeg?auto=compress&cs=tinysrgb&w=120",
      criteria: { quality: 5, delivery: 4, service: 5, value: 5 }
    }
  ];
  ...
  const followedVendors = [
    {
      ...
      specialty: "Poulets fermiers bio",
      location: "Thiès",
      rating: 4.8,
      totalPurchases: 5,
      lastPurchase: "25/08/25",
      notifications: true,
      newProducts: 2
    },
    {
      id: 2,
      name: "Élevage Bio Premium",
      avatar: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100",
      specialty: "Œufs bio & poussins",
      location: "Rufisque",
      rating: 4.6,
      totalPurchases: 3,
      lastPurchase: "22/08/25",
      notifications: true,
      newProducts: 1
    },
    {
      id: 3,
      name: "MatEquip Solutions",
      avatar: "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100",
      specialty: "Équipements avicoles",
      location: "Dakar",
      rating: 4.7,
      totalPurchases: 2,
      lastPurchase: "15/08/25",
      notifications: false,
      newProducts: 0
    }
  ];
  ...
  const menuItems = [
    ...
    { id: 'reviews', label: 'Historique & Évaluations', icon: <Star className="h-4 w-4" /> },
  ...
  const criteriaLabels = {
    ...
    delivery: 'Respect délais',
    service: 'Service client',
    value: 'Rapport qualité/prix'
  };

  const openEvaluationModal = (product: any) => {
    setSelectedProduct(product);
    setShowEvaluationModal(true);
    setRating(0);
    setCriteriaRatings({ quality: 0, delivery: 0, service: 0, value: 0 });
    setComment('');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900">Historique & Mes Évaluations</h1>
              <p className="text-gray-600">Évaluez vos achats et suivez vos vendeurs préférés</p>
            </div>
            ...
            <div className="mb-6">
              <div className="flex border-b border-gray-200">
                ...
                >
                  À Évaluer ({productsToReview.length})
                </button>
                <button
                  className={`px-6 py-3 font-medium text-sm ${
                  ...
                  onClick={() => setActiveTab('given-reviews')}
                >
                  Évaluations Données ({givenReviews.length})
                </button>
                <button
                  className={`px-6 py-3 font-medium text-sm ${
                  ...
                  onClick={() => setActiveTab('followed-vendors')}
                >
                  Vendeurs Suivis ({followedVendors.length})
                </button>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {productsToReview.map((product) => (
                  <Card key={product.id} className="p-4">
                    ...
                    <p className="text-xs text-gray-500 mb-1">Vendeur: {product.vendor}</p>
                    <p className="text-xs text-gray-500 mb-1">Acheté le: {product.purchaseDate}</p>
                    <p className="text-xs text-purple-600 font-medium mb-3">{product.price}</p>
                    <Button 
                      className="w-full bg-purple-600 hover:bg-purple-700 text-white text-sm"
                      onClick={() => openEvaluationModal(product)}
                    >
                      Évaluer Maintenant
                    </Button>
                  </Card>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Vendeur: {review.vendor}</p>
                          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {vendor.newProducts > 0 && (
                              <span className="bg-red-500 text-white px-2 py-1 rounded-full text-xs">
                                {vendor.newProducts} nouveau{vendor.newProducts > 1 ? 'x' : ''}
                              </span>
                            )}
                          </div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            {renderSmallStars(vendor.rating)}
                      ...
                      <div className="text-right">
                        <p className="text-sm text-gray-600 mb-1">
                          {vendor.totalPurchases} achat{vendor.totalPurchases > 1 ? 's' : ''}
                        </p>
                        <p className="text-xs text-gray-500 mb-3">
                          Dernier: {vendor.lastPurchase}
                        </p>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Bell className={`h-4 w-4 ${vendor.notifications ? 'text-purple-600' : 'text-gray-400'}`} />
                          <span className="text-xs text-gray-500">
                            Notifications {vendor.notifications ? 'activées' : 'désactivées'}
                          </span>
                        </div>
                      </div>
                    </div>
      ...
      {/* Modal Évaluation */}
      {showEvaluationModal && selectedProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b">
              <h3 className="text-lg font-semibold">Évaluer {selectedProduct.name}</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <form onSubmit={handleSubmitEvaluation} className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-3 bg-gray-50 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Vendeur: {selectedProduct.vendor}</p>
                  <p className="text-xs text-gray-500">Acheté le: {selectedProduct.purchaseDate}</p>
                </div>
              </div>
                        ...
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star
                            ...
                            className={`h-4 w-4 cursor-pointer ${
                              star <= criteriaRatings[key as keyof typeof criteriaRatings]
                                ? 'text-yellow-400 fill-current' 
                                : 'text-gray-300 hover:text-yellow-400'
                            }`}
                            onClick={() => setCriteriaRatings({
                              ...criteriaRatings,
                              [key]: star
                            })}
                          />
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Partagez votre expérience avec ce produit et ce vendeur..."
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                  ...
                  <p className="text-sm text-gray-600">Ajoutez des photos de votre achat</p>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">
                  Recommanderiez-vous ce vendeur ?
                </label>
