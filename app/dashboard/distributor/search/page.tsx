...
export default function SearchProducersPage() {
  ...
  const producers = [
    ...
    },
    {
      ...
      stock: "150",
      rating: 4.9,
      phone: "+221 76 987 654",
      location: "Rufisque, Dakar",
      image: "https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=80"
    },
    {
      id: 3,
      name: "Aïcha Ndiaye",
      product: "Œufs bio fermiers",
      price: "600",
      distance: "15km",
      stock: "200",
      rating: 4.7,
      phone: "+221 78 456 789",
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            <Card className="p-6 mb-6">
              ...
              <div className="relative bg-gradient-to-br from-green-100 to-blue-100 rounded-lg h-64 overflow-hidden">
                {/* Simulation Google Maps */}
                <div className="absolute inset-0 bg-gray-200 opacity-30"></div>
                
                {/* Pins des producteurs */}
            ...
            {/* Liste Producteurs */}
            <Card className="p-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Producteurs Trouvés ({producers.length})</h2>
                  ...
                  <tbody>
                    {producers.map((producer, index) => (
                      <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-3 px-4 text-gray-600">{producer.stock} unités</td>
                        <td className="py-3 px-4">
