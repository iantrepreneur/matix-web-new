...
export default function DistributorDashboard() {
  ...
  if (!currentUser || currentUser.profile !== 'distributeur') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Accès non autorisé</h1>
          <p className="text-gray-600 mb-6">Seuls les distributeurs peuvent accéder à cette page.</p>
          <Link href="/">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card className="p-6">
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-xs text-blue-600 capitalize">{currentUser.profile}</p>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Gérez vos relations avec les producteurs et vos clients</p>
            </div>
                  ...
                  <tbody>
                    {currentAlerts.map((alert, index) => (
                      <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-3 px-4">{getStatusBadge(alert.statut)}</td>
