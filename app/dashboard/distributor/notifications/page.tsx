...
export default function DistributorNotificationsPage() {
  ...
  if (loading) {
    return (
      <DistributorLayout currentUser={currentUser} activePage="notifications">
      ...
      <div className="space-y-6">
        ...
        <div className="flex space-x-2">
          {[
            ...
            { key: 'proposition_accepted', label: 'Propositions acceptées' },
            { key: 'proposition_rejected', label: 'Propositions refusées' },
            { key: 'alert_match', label: 'Alertes' },
            { key: 'new_producer', label: 'Nouveaux producteurs' }
          ].map((filterOption) => (
            <button
                ...
                {notification.data && Object.keys(notification.data).length > 0 && (
                  <div className="mt-3 pt-3 border-t border-gray-200">
                    <div className="text-xs text-gray-600">
                      {notification.type === 'proposition_accepted' && notification.data.product_name && (
