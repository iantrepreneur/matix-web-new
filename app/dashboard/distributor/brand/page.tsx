...
export default function MyBrandPage() {
  ...
  const copyStoreLink = () => {
    const storeUrl = "https://matix.sn/store/fatou-enterprises";
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Configurez votre boutique en marque blanche</p>
            </div>

            {/* Configuration Marque */}
            <Card className="p-6 mb-6">
              <h2 className="text-lg font-semibold mb-6">Configuration de la Marque</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-600 text-sm">Upload logo (PNG, JPG)</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-600 text-sm">Upload bannière (1200x400px)</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Input defaultValue="Fatou Enterprises Store" />
                </div>
                ...
                <div>
                  ...
                  <Input defaultValue="Distributeur officiel produits avicoles" />
                </div>
              </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <Input value={brandColors.primary} className="flex-1" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-12 h-8 rounded border"
                      />
                      <Input value={brandColors.secondary} className="flex-1" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-12 h-8 rounded border"
                      />
                      <Input value={brandColors.accent} className="flex-1" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Card className="p-6 mb-6">
              ...
              <div className="flex items-center gap-3">
                <Input 
                  value="https://matix.sn/store/fatou-enterprises"
                  readOnly
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-gray-600">Prix Achat</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600">Marge</th>
                      <th className="text-left py-3 px-4 font-medium text-gray-600">Prix Final</th>
                  ...
                  <tbody>
                    {selectedProducts.map((product, index) => (
                      <tr key={index} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <td className="py-3 px-4 text-gray-600">{product.producer}</td>
                        <td className="py-3 px-4 text-gray-600">{product.price} FCFA</td>
                        <td className="py-3 px-4 text-gray-600">{product.margin} FCFA</td>
                        <td className="py-3 px-4 font-medium text-blue-600">{product.finalPrice} FCFA</td>
                        <td className="py-3 px-4">
                          <div className="flex items-center gap-2">
